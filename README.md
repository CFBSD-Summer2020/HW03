...
#####
I imported immune.csv and created a boxplot showing the relative expression of the gene Cd19 among different types of mouse samples with a focus on immune cells. The immune.csv contains mouse microarray data from a online database [http://refdic.rcai.riken.jp/welcome.cgi] that I used in a previous lab I worked in to help me explore some single-cell RNA-seq data I had access to.